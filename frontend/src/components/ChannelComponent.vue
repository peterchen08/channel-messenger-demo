...
let requests = reactive([
	{
		id: 'list',
		action: 'v1.channels.list',
		rest: '/api/v1/channels/',
		response: null,
		status: null,
		duration: null,
	...
	{
		id: 'get',
		action: 'v1.channels.get',
		rest: '/api/v1/channels/:id',
		method: 'GET',
		fields: [{ field: 'id', label: 'ID', type: 'text', paramType: 'url', model: 'channelID' }],
		response: null,
		status: null,
		duration: null,
	},
	{
		id: 'update',
		action: 'v1.channels.update',
		rest: '/api/v1/channels/:id',
		method: 'PUT',
		fields: [
			{ field: 'id', label: 'ID', type: 'text', paramType: 'url', model: 'channelID' },
			{
				field: 'name',
				label: 'Name',
				type: 'text',
